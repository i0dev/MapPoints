package com.i0dev.MapPoints.hooks;
...
public class MCoreFactionsHook {
    ...
    public static List<UUID> getAllPlayersInFaction(Object faction) {
        List<UUID> players = new ArrayList<>();

        ((Faction) faction).getMPlayers().forEach(mPlayer -> players.add(UUID.fromString(mPlayer.getId())));
